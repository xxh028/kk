							...
							<tr>
								...
								<td><input type="radio" id="gender" name="gender"
									...
									<input type="radio" id="gender" name="gender"
									 aria-required="true" required value="女"/>女
								...
								<td><img  src="" id="pic" height="50" width="50"><input type="file" id="pic" name="picFile" aria-required="true" required /></td>
								<td><input type="hidden" id="pics" /></td>
							</tr>
							 <tr>
								<td>部门：</td>
								<td>
