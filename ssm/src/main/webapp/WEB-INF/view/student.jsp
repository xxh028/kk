...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td><input type="radio" id="sex" name="sex" aria-required="true" required value="男"/>男
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
								<td><input type="date" id="bir" name="bir" aria-required="true" required />
							...
							<tr>
								...
								<input type="file"  name="picFile" class="form-control" aria-required="true" required/>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form id="form_user_import" action="importStudent.htm" method="post" enctype="multipart/form-data">
	...
	function initEditUser(getSelection){
		...
		$('#pic').attr('src',"/photo/"+getSelection.pic);
