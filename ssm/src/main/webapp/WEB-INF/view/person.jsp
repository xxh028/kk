	...
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_start" name="starttime" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间" id="txt_search_end" name="endtime" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>人员性别：</td>
								<td><input type="radio" id="gender" name="gender"  aria-required="true" required value="男"/>男
								<td><input type="radio" id="gender" name="gender"  aria-required="true" required value="女"/>女
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>人员生日：</td>
								<td><input type="date" id="birthday" name="birthday" class="form-control" aria-required="true" required />
